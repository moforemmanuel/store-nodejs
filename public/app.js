...
const cartContent = document.querySelector(".cart__center");
...
const checkoutCartBtn = document.querySelector(".checkout__cart");
const increaseBtn = document.querySelector(".increase");
const decreaseBtn = document.querySelector(".decrease");

//export {productDOM,cartDOM,cartContent,openCart,closeCart,overlay,cartTotal,clearCartBtn,itemTotals};
...
class UI {
  ...
  setAPP() {
    ...
    //checkoutCartBtn.addEventListener("click", function(){alert("yo");});
